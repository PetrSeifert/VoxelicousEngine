...
namespace VoxelicousEngine
{
    ...
    // used to "uniquely" identify information. In VoxelicousEngine, even though we use the term
...
namespace std {
    ...
    template <>
    struct hash<VoxelicousEngine::UUID>
    {
        std::size_t operator()(const VoxelicousEngine::UUID& uuid) const
        {
    ...
    template <>
    struct hash<VoxelicousEngine::UUID32>
    {
        std::size_t operator()(const VoxelicousEngine::UUID32& uuid) const
        {
