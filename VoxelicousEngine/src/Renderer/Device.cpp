...
namespace VoxelicousEngine
{
	...
	Device::Device(VkInstance vkInstance, VkSurfaceKHR surface) : m_VkInstance(vkInstance)
	{
	...
	{
		QueueFamilyIndices queueFamilyIndices = FindPhysicalQueueFamilies(surface);
